  ...
  useEffect(() => {
    ...
    if (!document.getElementById('kids-game-anims')) {
      ...
      style.textContent = [
        ...
        '@keyframes kg-wipeDown{0%{clip-path:inset(0 0 100% 0)}100%{clip-path:inset(0 0 0% 0)}}',
        '@keyframes kg-wipeRight{0%{clip-path:inset(0 100% 0 0)}100%{clip-path:inset(0 0% 0 0)}}',
