...
import { StoryLab } from '@/components/kids/phonics/StoryLab'

type Tab = 'vocab' | 'grammar' | 'eiken' | 'puzzles' | 'situations' | 'phonicsStory'
...
const TABS: { id: Tab; label: string }[] = [
  ...
  { id: 'phonicsStory', label: 'Phonics Story Lab' },
]
